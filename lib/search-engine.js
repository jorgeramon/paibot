...
function processResponse(response) {
  ...
  return data.list_ads.map(data => ({
    rooms: data.ad.ad_details && data.ad.ad_details.rooms ? data.ad.ad_details.rooms.single.label : 'No especificado',
    bathrooms: data.ad.ad_details && data.ad.ad_details.bathrooms ? data.ad.ad_details.bathrooms.single.label : 'No especificado',
    size: data.ad.ad_details && data.ad.ad_details.size ? data.ad.ad_details.size.single.label : 'No especificado',
